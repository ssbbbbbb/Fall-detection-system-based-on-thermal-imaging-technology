...
| **`fall_detection_gru.pth`** | **GRU + Attention** | **Action Recognition**: Analyzes the temporal trajectory of the last 10 frames using an attention mechanism to classify "fall" patterns. | [Download](https://drive.google.com/file/d/1535UT4mYRSz5veQtXrwcWfReF8CTlHH8/view?usp=drive_link) |
