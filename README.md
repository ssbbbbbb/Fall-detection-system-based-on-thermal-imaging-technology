...
| **`fall_detection_gru.pth`** | **GRU + Attention** | **Action Recognition**: Analyzes the temporal trajectory of the last 10 frames using an attention mechanism to classify "fall" patterns. | [Download](https://drive.google.com/file/d/1aXCHJ2xOHDQC4uOrF-Vqgodkdp0VHpWN/view?usp=sharing) |
...
| **`test_data.zip`** | [Download](https://drive.google.com/file/d/1hVrUDfkTNZ6Fo-Zgv2sebUQoS9qF_aJJ/view?usp=sharing) |
