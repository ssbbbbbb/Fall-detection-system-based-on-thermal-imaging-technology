...
| **`fall_detection_gru.pth`** | **GRU + Attention** | **Action Recognition**: Analyzes the temporal trajectory of the last 10 frames using an attention mechanism to classify "fall" patterns. | [Download](https://drive.google.com/file/d/1wAQbKZK12HQj_-iNQHvKLHO-KB5lPb36/view?usp=sharing) |
